...
### Fixed
- **Multi-line Mapping Bug:** Fixed issue with multi-line mappings in column selection mode where mappings were not being applied correctly across multiple lines (Bug #11).
...
- **Single Character Only Mode:**
  - Added `stuttering.singleCharOnly` configuration option
